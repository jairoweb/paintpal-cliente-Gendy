...
export default function AuthPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (error) {
        toast({ title: "Error con Google", description: "No se pudo iniciar sesión con Google.", variant: "destructive" });
      }
    } catch (err) {
      toast({ title: "Error con Google", description: "Inténtalo de nuevo.", variant: "destructive" });
    }
    ...
    <div className="min-h-screen flex items-center justify-center p-4 gradient-primary">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white tracking-tight">Asistente de Jairo</h1>
        ...
        <Card className="shadow-elevated border-0">
          ...
          <CardContent>
            <Button
              type="button"
              variant="outline"
              className="w-full h-11 text-base font-medium gap-3 mb-4"
